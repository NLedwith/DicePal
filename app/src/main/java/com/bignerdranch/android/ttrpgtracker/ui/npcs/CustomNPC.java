...
public class CustomNPC implements Serializable, Comparable<CustomNPC>{
    private String name;
    private Integer hp;
    ...
    @Override
    public int compareTo(CustomNPC o) {
